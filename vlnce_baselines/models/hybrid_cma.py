...
class TransformerEncDec(Net):
    ...
    def __init__(self, observation_space: Space, model_config: Config, num_actions, batch_size, gpus):
        ...
        self.action_decoder = HybridActionDecoder(model_config.ACTION_DECODER_TRANFORMER)
    ...
    def single_forward(self, visual_embeddings, lang_encoding, progress, prev_actions, rnn_hidden_states, masks):
        ...
        visual_enc_out = self.image_cm_encoder(rgbd_out, ins_enc_out, None, enc_mask, pos_embed_out) # Cross Modal RGB-D & Text Attention
        ...
        sem_enc_out, _ = self.sem_map_encoder(sem_map, ins_enc_out, None, enc_mask)
        ...
        out, rnn_hidden_states = self.action_decoder(x, ins_enc_out, None, enc_mask, pos_embed_out, rnn_hidden_states, 
    ...
    def seq_forward(self, visual_embeddings, lang_encoding, progress, prev_actions, rnn_hidden_states, masks):
        ...
        for i in range(max_len):
            prev_actions_single       = prev_actions[:,:i]
            masks_single              = masks[:,:i]
