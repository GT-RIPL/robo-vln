...
class TransformerEncDec(Net):
    ...
    def single_forward(self, visual_embeddings, lang_encoding, progress, prev_actions, prev_actions_list, masks, prev_action_pad_mask=None):
        ...
        out = self.action_decoder(prev_action_seq, ins_enc_out.to(self.gpu0), visual_semantic_enc.to(self.gpu0), enc_att_mask_w=enc_mask.to(self.gpu0), 
                                    enc_att_mask_i=None, device=self.device, pos_embed= pos_embed_out.to(self.gpu0))
